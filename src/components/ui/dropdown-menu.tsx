...
const DropdownMenu = ({ ...props }: React.ComponentProps<typeof Root>) => <Root data-slot="dropdown-menu" {...props} />;

const DropdownMenuPortal = ({ ...props }: React.ComponentProps<typeof Portal>) => <Portal data-slot="dropdown-menu-portal" {...props} />;

const DropdownMenuTrigger = ({ ...props }: React.ComponentProps<typeof Trigger>) => (
...
const DropdownMenuGroup = ({ ...props }: React.ComponentProps<typeof Group>) => <Group data-slot="dropdown-menu-group" {...props} />;
...
const DropdownMenuRadioGroup = ({ ...props }: React.ComponentProps<typeof RadioGroup>) => (
...
const DropdownMenuSub = ({ ...props }: React.ComponentProps<typeof Sub>) => <Sub data-slot="dropdown-menu-sub" {...props} />;
